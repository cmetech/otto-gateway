@echo off
REM scripts/gw.bat - dispatcher for Windows operators who prefer cmd.exe over PowerShell.
REM Routes every argument through to scripts/gw.ps1 with -ExecutionPolicy Bypass so it
