...
- ✅ **v1.10.4 Privacy Boundary Service implementation** — Phase 21 complete locally on 2026-08-01; not tagged, published, or released. Implements the approved privacy-boundary design and 17-task strict-TDD plan; covers PRIV-01..12 across policy, mapping lifecycle, fail-closed boundaries, surface parity, safe operations, and release gates.

## Phases

### v1.10.4 Privacy Boundary Service

- [x] **Phase 21: Privacy Boundary Service** — Implemented the approved modular, in-process privacy boundary shared by Ollama, OpenAI, and Anthropic. The plan executed all 17 authoritative tasks with observed RED/GREEN cycles, atomic task commits and focused correction commits, review gates, race/security/conformance checks, POSIX/PowerShell parity, documentation, Grafana assets, benchmarks, and the complete release gate. Requirements: PRIV-01..12. Completed 2026-08-01; milestone remains unpublished.
...
<details>
<summary>✅ v1.10.3 Reliability Closeout — SHIPPED 2026-06-12 (3 phases, 5 plans, 17 REQ-IDs)</summary>

- [x] **Phase 18: Reliability long-tail** — Config hardening (REL-CFG-05/06/07) + observability symmetry (REL-HTTP-06/07, REL-OBSV-02/03/04) + tray honesty (REL-TRAY-08/09). 3 parallel plans, zero file overlap.
- [x] **Phase 19: acp.Stream concurrency fix** — REL-ACP-01: `Result()` copy-under-lock; Phase 17 test-side drain-Chunks-then-Result workaround surgically reverted; 60-iter race-loop whitebox regression (6,000 trials clean).
- [x] **Phase 20: Code-review backlog burn-down** — QUAL-01..06 closed as 6 atomic refactor commits (escapeApplescript escape set, tooltipForState dedup, forceCloseCh relocate, tailLines collect-then-reverse, dead-var + stale-comment cleanups). Refactor-only.

Full per-phase detail: [v1.10.3-ROADMAP.md archive](milestones/v1.10.3-ROADMAP.md) · audit: [v1.10.3-MILESTONE-AUDIT.md](milestones/v1.10.3-MILESTONE-AUDIT.md)

</details>

## Phase Details

v1.9 + v1.10.3 phase details archived to `milestones/v{ver}-ROADMAP.md`.
