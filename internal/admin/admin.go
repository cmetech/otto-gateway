...
func (h *handler) docsHandler(w http.ResponseWriter, r *http.Request) {
	...
	envVars := []envVarRow{
		...
		{Name: "CHAT_TRACE_FILE", Default: "./logs/gateway-chat-trace.log (or sibling of LOG_FILE)", Description: "On-disk path of the chat-trace NDJSON log. Only opened when CHAT_TRACE=true.", CurrentValue: chatTraceFileCurrent},
