// Package anthropic — whitebox test file.
// TestMain installs the goleak goroutine-leak gate for the entire
// anthropic adapter package test suite. Any test that leaves a
// goroutine running after it returns will cause the suite to fail.
// (TRST-05 — particularly important for Plan 03.1-03's SSE handler
...
// TestMain is the entry point for all tests in the anthropic package.
