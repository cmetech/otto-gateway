...
// into dst. handleMessages uses this helper so the body size cap is
...
// Per Phase 3.1 D-10, anthropic-beta and cache_control fields (plus any
// new SDK-side additions) are accepted-and-ignored. Failing on unknown
// fields would break compatibility with @anthropic-ai/sdk releases that
// add new request fields (e.g., extended_thinking, future cache_control
// variants).
...
// by handleMessages to distinguish a 413 request_too_large from a 400
