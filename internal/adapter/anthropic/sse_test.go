...
func TestRunSSEEmitter_NoFlusherError(t *testing.T) {
	...
	_, err := runSSEEmitter(context.Background(), nfw, runHandle, nil, nil, "auto", 0, nullLogger())
...
func TestRunSSEEmitter_EndToEnd_Headers(t *testing.T) {
	...
	_, err := runSSEEmitter(context.Background(), rec, runHandle, nil, nil, "auto", 0, nullLogger())
	if err != nil {
