...
func (s *trayState) onReady(isFirstRun bool) func() {
	return func() {
		...
		s.miDesktopHeader = systray.AddMenuItem(desktopLabel(did, "· …"), "")
		s.miDesktopHeader.Disable()
		s.miDesktopInstall = systray.AddMenuItem("Install "+desktopLabel(did, "")+"…", "Download and run the "+did.DisplayName+" desktop installer")
		s.miDesktopStart = systray.AddMenuItem("Start "+desktopLabel(did, ""), "")
		s.miDesktopStop = systray.AddMenuItem("Stop "+desktopLabel(did, ""), "")
		systray.AddSeparator()
